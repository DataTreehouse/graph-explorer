...
module.exports = {
  ...
  mode: 'production',
  entry: {
    'fuseki-lucene': path.join(examplesDir, 'fuseki-lucene.ts'),
    'fuseki-regexsearch': path.join(examplesDir, 'fuseki-regexsearch.ts'),
  ...
  plugins: [
    ...
    // }),
    new HtmlWebpackPlugin({
      filename: 'fuseki-lucene.html',
      title: 'Ontodia Graph Explorer',
      chunks: ['commons', 'fuseki-lucene'],
      template: htmlTemplatePath,
    }),
    new HtmlWebpackPlugin({
      filename: 'fuseki-regexsearch.html',
      title: 'Ontodia Graph Explorer',
      chunks: ['commons', 'fuseki-regexsearch'],
      template: htmlTemplatePath,
    }),
    // new HtmlWebpackPlugin({
